return {
    ...
    config = function()
      ...
      local servers = {
        ...
        -- NEW SERVERS FOR LARAVEL/REACT DEVELOPMENT
        
        -- PHP Language Server (for Laravel)
        intelephense = {
          settings = {
            intelephense = {
              files = {
              ...
              stubs = {
                ...
                'iconv', 'imap', 'intl', 'json', 'ldap', 'libxml', 'mbstring', 'mcrypt', 'meta',
                'mssql', 'mysqli', 'oci8', 'odbc', 'openssl', 'pcntl', 'pcre', 'PDO', 'pdo_ibm',
                ...
                'SPL', 'sqlite3', 'standard', 'superglobals', 'sysvsem', 'sysvshm', 'tidy', 'tokenizer',
                'xml', 'xmlreader', 'xmlrpc', 'xmlwriter', 'xsl', 'Zend OPcache', 'zip', 'zlib',
                'wordpress', 'woocommerce', 'acf-pro', 'wordpress-globals', 'wp-cli', 'laravel',
              },
              environment = {
                includePaths = { 'vendor', 'resources' },
              },
              completion = {
        ...
        -- Emmet Language Server (for HTML/JSX shortcuts)
        emmet_ls = {
          filetypes = {
        ...
        -- SQL Language Server (for database work)
        sqlls = {},

        -- Vue Language Server (if you use Vue with Laravel)
        -- volar = {
        --   filetypes = { 'vue' },
        -- },
        ...
        -- prismals = {}, -- Prisma ORM
        -- graphql = {}, -- GraphQL
        -- eslint = {}, -- ESLint (though you might prefer null-ls for this)
      }
      ...
      -- Additional file type associations for Laravel Blade
      ...
      -- Set up proper indentation for different file types
      vim.api.nvim_create_autocmd('FileType', {
        pattern = { 'javascript', 'javascriptreact', 'typescript', 'typescriptreact', 'json', 'html', 'css', 'yaml' },
        callback = function()
